...
VALUES (1, 1, '신라갈비', '경기도 수원시 영통구 동수원로 538', '수원 3대 갈비 맛집'),
       (1, 2, '누크녹', '경기 수원시 팔달구 화서문로31번길 14-32 1 2층', '누크녹은 골목에 위치해 있지만, 멀리서도 존재감 퐁퐁'),
       (1, 3, '만석공원', '경기 수원시 장안구 송죽동 248', '밥 먹고 느즈막히 산책하기');
...
VALUES (2, 1, '해운대 블루라인파크', '부산시 해운대구 중동 948-1', '해변을 따라 달리는 스카이캡슐과 해변열차가 있습니다.'),
       (2, 2, '송정해수욕장', '부산시 해운대구 송정동', '서핑으로 유명한 비교적 한적한 해변입니다.');
...
VALUES (3, 1, '주남저수지', '경남 창원시 의창구 대산면 유등리', '철새들이 많아 아름다운 곳'),
       (3, 2, '저도', '경남 창원시 의창구 대산면 유등리', '한적하지만 소박하고 아름다운 곳');
