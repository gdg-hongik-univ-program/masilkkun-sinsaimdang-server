...
VALUES (1, 1, '신라갈비', '경기도 수원시 영통구 동수원로 538', '수원 3대 갈비 맛집', 'https://www.esquirekorea.co.kr/resources_old/online/org_online_image/eq/afcd68be-5e61-4ec0-832f-b572c13634c0.jpg'),
       (1, 2, '누크녹', '경기도 수원시 팔달구 화서문로31번길 14-32 1 2층', '누크녹은 골목에 위치해 있지만, 멀리서도 존재감 퐁퐁', 'https://d12zq4w4guyljn.cloudfront.net/750_750_20250603084601_photo1_66362ea9f767.webp'),
       (1, 3, '만석공원', '경기도 수원시 장안구 송죽동 248', '밥 먹고 느즈막히 산책하기', 'https://ggc.ggcf.kr/uploadimg/resize/ce9fb7f81544103150251.jpeg');
...
INSERT INTO article_places (article_id, place_order, place_name, address, description, photo_url)
VALUES (2, 1, '해운대 블루라인파크', '부산광역시 해운대구 중동 948-1', '해변을 따라 달리는 스카이캡슐과 해변열차가 있습니다.', 'https://www.visitbusan.net/uploadImgs/files/cntnts/20191227195613061_oen'),
       (2, 2, '송정해수욕장', '부산광역시 해운대구 송정동', '서핑으로 유명한 비교적 한적한 해변입니다.', 'https://tourimage.interpark.com/BBS/Tour/FckUpload/201706/6363304827248806650.jpg');
...
INSERT INTO article_places (article_id, place_order, place_name, address, description, photo_url)
VALUES (3, 1, '주남저수지', '경상남도 창원시 의창구 대산면 유등리', '철새들이 많아 아름다운 곳', 'https://culture.changwon.go.kr/cmm/fms/getImage.do?atchFileId=FILE_000000000008746'),
       (3, 2, '저도', '경상남도 창원시 의창구 대산면 유등리', '한적하지만 소박하고 아름다운 곳', 'https://eiec.kdi.re.kr/userdata/nara/202108/edit/aaauOBDTNDE3Kaf343HRx_1627448711563.jpg');
...
INSERT INTO article_places (article_id, place_order, place_name, address, description, photo_url)
VALUES (4, 1, '제주 맛집', '제주특별자치도 제주시 어딘가', '제주 전통의 맛', 'https://digitalchosun.dizzo.com/site/data/img_dir/2021/03/05/2021030580086_0.jpg'),
       (4, 2, '제주 맛집', '제주특별자치도 제주시 어딘가', '제주 특산물의 맛', 'https://i.ytimg.com/vi/AdnXgPYZgR8/maxresdefault.jpg');
